...
var _rtfeldman$elm_css$Css_Namespace$applyNamespaceToStyle = F2(
	function (name, style) {
		var _p7 = style;
		switch (_p7.ctor) {
			case 'AppendProperty':
			...
			case 'ExtendSelector':
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						_rtfeldman$elm_css$Css_Namespace$applyNamespaceToStyle(name),
						_p7._1));
			case 'NestSnippet':
				return A2(
...
var _user$project$PageCss$colorWheel = {
	...
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '#dbefec', _1: '#00a7a1'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '#feeedf', _1: '#ff9400'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '#e1f0e4', _1: '#00b63e'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '#e0eff4', _1: '#00ade5'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: '#fae3e2', _1: '#e12229'},
						_1: {ctor: '[]'}
					}
				}
			}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill(_user$project$PageCss$blueFontColor),
						_1: {
							ctor: '::',
						...
						},
						{
							...
							_0: _elm_lang$svg$Svg$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(
										(_elm_lang$core$Basics$round(x) / 100) | 0),
									A2(
										_elm_lang$core$Basics_ops['++'],
										' / ',
										_elm_lang$core$Basics$toString(
...
var _user$project$Chart$rangeFrameHintDot = F2(
	function (color, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._1;
		var _p2 = _p1._0;
...
var _user$project$Chart$scatter = function (color) {
	return {
		...
		toDataPoints: _elm_lang$core$List$map(
			_user$project$Chart$rangeFrameHintDot(color))
	};
};
var _user$project$Chart$graph = F2(
	function (color, data) {
		return A3(
			...
			{
				ctor: '::',
				_0: _user$project$Chart$scatter(color),
				_1: {ctor: '[]'}
			},
			data);
	});
	...
	function (len, xs) {
		...
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(
				...
				var _v0 = len,
					_v1 = A2(_elm_lang$core$Basics_ops['++'], xs, xs);
				len = _v0;
				xs = _v1;
				continue cycle;
			}
...
var _user$project$ListHelper$zipWithCycle = F2(
	function (xs, ys) {
		return A2(
			_elm_community$list_extra$List_Extra$zip,
			xs,
			A2(
				_user$project$ListHelper$cycle,
				_elm_lang$core$List$length(xs),
				ys));
	});
