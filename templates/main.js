...
var _user$project$Views$groupEach = F2(
	function (times, list) {
		var f = F2(
			function (a, _p0) {
				var _p1 = _p0;
				...
				var _p3 = _p1._1;
				var _p2 = _p1._0;
				return (_elm_lang$core$Native_Utils.eq(_p2, times) || _elm_lang$core$Native_Utils.eq(_p3, 1)) ? {
					ctor: '_Tuple4',
					_0: 1,
					_1: _p3 - 1,
					_2: {ctor: '[]'},
		...
		var _p6 = A3(
			...
			f,
			{
				ctor: '_Tuple4',
				_0: 1,
				_1: _elm_lang$core$List$length(list),
				_2: {ctor: '[]'},
				_3: {ctor: '[]'}
			},
			list);
		var grouped = _p6._3;
		return _elm_lang$core$List$reverse(grouped);
	});
var _user$project$Views$mapLang = function (_p7) {
	var _p8 = _p7;
	return {
		label: _p8._0,
		data: A2(
			...
			function (lang) {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$toFloat(lang.year + lang.month),
					_1: _elm_lang$core$Basics$toFloat(lang.stars)
				};
			},
			_p8._1)
	};
};
var _user$project$Views$sampleDataset = function (model) {
	return A2(_elm_lang$core$List$map, _user$project$Views$mapLang, model);
};
...
var _user$project$Views$mapModelToLangGrouped = function (model) {
	return _elm_lang$core$List$reverse(
		A2(
			...
			function (_p9) {
				var _p10 = _p9;
				return _user$project$Views$getFirstStars(_p10._1);
			},
...
var _user$project$Views$makeListItem = function (_p11) {
	var _p12 = _p11;
	var stars = _user$project$Views$getFirstStars(_p12._1);
	return A2(
...
var _user$project$Views$viewCharts = function (langs) {
	var renderChart = function (langList) {
		return A2(
			_juanedi$charty$Charty_LineChart$view,
			_juanedi$charty$Charty_LineChart$defaults,
			_user$project$Views$sampleDataset(langList));
	};
	return A2(
		_elm_lang$core$List$map,
		renderChart,
		A2(_user$project$Views$groupEach, 5, langs));
};
			...
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						A2(_elm_lang$core$List$map, _user$project$Views$makeListItem, topGrouped)),
					_1: {ctor: '[]'}
				}
			},
